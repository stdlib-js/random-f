...
interface RandomFunction extends PRNG {
	/**
	* Returns an ndarray containing pseudorandom numbers drawn from an F distribution.
	*
	...
	*/
	<T extends typedndarray<number>, U extends typedndarray<number>>( shape: Shape, d1: number | T, d2: number | U, options?: Options ): RandomArray;

	/**
	* Fills an ndarray with pseudorandom numbers drawn from an F distribution.
	*
	* @param d1 - degrees of freedom
	* @param d2 - degrees of freedom
	...
	* @returns output ndarray
	*/
	assign<T extends typedndarray<number>, U extends typedndarray<number>, V extends typedndarray<number>>( d1: number | T, d2: number | U, out: V ): V;
}
...
interface Random extends PRNG {
	...
	*/
	...
	/**
	* Returns a function for creating ndarrays containing pseudorandom numbers drawn from an F distribution.
	*
	* @param options - function options
